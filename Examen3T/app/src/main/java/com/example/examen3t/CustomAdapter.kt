...
import com.example.examen3t.databinding.ElementoAzulBinding

class CustomAadapter(private val listaDiscos:MutableList<Album>) : RecyclerView.Adapter<CustomAadapter.ViewHolder>() {
